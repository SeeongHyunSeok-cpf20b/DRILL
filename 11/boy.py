...
# Boy Event
RIGHT_DOWN, LEFT_DOWN, RIGHT_UP, LEFT_UP, SLEEP_TIMER, SHIFT_DOWN, RUN_TIMER = range(7)
...
class Boy:
    ...
    def draw(self):
        ...
        if self.cur_state == DashState:
            debug_print('Velocity :' + str(self.velocity*2) + ' Dir:' + str(self.dir)+ ' State' + str(self.cur_state))
        else:
